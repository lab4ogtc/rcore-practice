...
struct AppManagerInner {
    ...
    app_name: [&'static str; MAX_APP_NUM],
}
...
impl AppManagerInner {
    ...
    unsafe fn load_app(&self, app_id: usize) {
        ...
        info!("[kernel] Loading app_{}: {}", app_id, self.app_name[app_id]);
        // clear icache
        asm!("fence.i");
        // clear app area
...
lazy_static! {
    static ref APP_MANAGER: AppManager = AppManager {
        inner: RefCell::new({
            ...
            unsafe {
                let app_names_raw: &[usize] =
                    core::slice::from_raw_parts(app_names_ptr, num_app + 1);
...
pub fn check_address_available(addr: usize) -> bool {
    (addr <= USER_STACK.get_sp() && addr >= (USER_STACK.get_sp() - USER_STACK_SIZE))
